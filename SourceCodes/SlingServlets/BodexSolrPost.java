...
@SlingServlet(paths = "/bin/bodex/bodexsolrpost", methods = "GET")
public class BodexSolrPost extends SlingSafeMethodsServlet {
	private static final long serialVersionUID = -3960692666512058118L;
	public String res;
	@Override
	protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)throws ServletException, IOException {
		response.setHeader("Content-Type", "application/json");
		String incoming=request.getParameter("fillByString");
		String srchField=request.getParameter("fillByTag");
